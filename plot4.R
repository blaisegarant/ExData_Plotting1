...
par(mfcol=c(2,2))
plot(mydata$Global_active_power, type='l', xlab='', ylab = 'Global Active Power', xaxt='n')
...
legend('topright', lty=1, col=c('black','red', 'blue'), legend=tail(names(mydata),n=3),bty='n')
add_weekday_axis(mydata$Date)
